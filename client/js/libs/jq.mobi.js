        ...
        $.ajax = function(opts) {
            ...
            try {
                ...
                if (!settings.headers)
					...
					//console.log( kget('basic_username') );
					if( kget('basic_username') && kget('basic_username').length > 0 )
					{
						settings.headers = $.extend({'Authorization': "Basic " + Base64.encode( kget('basic_username')+':'+kget('basic_password') )}, settings.headers);
					}
